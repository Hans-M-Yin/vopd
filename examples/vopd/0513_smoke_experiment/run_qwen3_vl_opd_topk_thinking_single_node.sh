...
# with a thinking teacher.
#
# This mirrors run_qwen3_vl_opd_topk_single_node.sh, but switches the
# distillation teacher to qwen3-vl-32b-thinking.
...
MAX_RESPONSE_LENGTH=${MAX_RESPONSE_LENGTH:-4000}
PPO_MAX_TOKEN_LEN_PER_GPU=${PPO_MAX_TOKEN_LEN_PER_GPU:-14000}
...
DATE=${DATE:-$(date +%m%d)}
EXPERIMENT_NAME=${EXPERIMENT_NAME:-${DATE}_qwen3-vl_opd_topk_thinking_smoke_single_node}
